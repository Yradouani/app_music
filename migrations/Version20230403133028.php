 ...
 */
final class Version20230403133028 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE favorite (id INT AUTO_INCREMENT NOT NULL, id_user_id INT NOT NULL, id_track VARCHAR(255) NOT NULL, INDEX IDX_68C58ED979F37AE5 (id_user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE playlist (id INT AUTO_INCREMENT NOT NULL, id_user_id INT NOT NULL, name_playlist VARCHAR(255) NOT NULL, id_track VARCHAR(255) NOT NULL, INDEX IDX_D782112D79F37AE5 (id_user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
